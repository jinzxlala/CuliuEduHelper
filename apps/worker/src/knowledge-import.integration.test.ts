...
async function runFailureScenario(initialAttempts: 0 | 1 | 3): Promise<void> {
  ...
  const worker = createTaskWorker({
    ...
    handlers: {
      ...
      "knowledge.smart-search": () => Promise.resolve({ skipped: true }),
      "knowledge.analysis-chat": () => Promise.resolve({ skipped: true }),
      "knowledge.analysis-report": () => Promise.resolve({ skipped: true }),
      "profile.draft": () => Promise.resolve({ skipped: true }),
      "student.basic.extract": () => Promise.resolve({ skipped: true }),
      "student.evidence.extract": () => Promise.resolve({ skipped: true }),
      "course.recommendation.generate": () => Promise.resolve({ skipped: true }),
      "timetable.solve": () => Promise.resolve({ skipped: true }),
